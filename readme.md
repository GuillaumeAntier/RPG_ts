Welcome to our RPG project, for this project we used TypeScript and POO. The aim of this project is to create a command-line RPG game. To launch the game, you have to type the command "deno run index.js". 
