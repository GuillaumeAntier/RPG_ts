...
export default class Boss extends Character {
    ...
    monsterAttack(target : Character[]){
        ...
        if (random < 30){
            console.log(`${this.name} attacks all the characters with 40% of his physical attack`);
            for (let characters of target){
                ...
                console.log(`${characters.name} has ${characters.currentLifePoints} life points left`);
            }
        } else {
